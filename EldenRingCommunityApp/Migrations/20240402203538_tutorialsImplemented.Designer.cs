...
namespace EldenRingCommunityApp.Migrations
{
    ...
    [Migration("20240402203538_tutorialsImplemented")]
    partial class tutorialsImplemented
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EldenRingCommunityApp.Models.JoinTables.BuildSpells", b =>
                {
                    b.Property<int>("BuildSpellsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildSpellsId"));
                    ...
                    b.HasKey("BuildSpellsId");

                    b.HasIndex("BuildId");

                    b.HasIndex("SpellId");

                    b.ToTable("BuildSpells");
                });

            modelBuilder.Entity("EldenRingCommunityApp.Models.JoinTables.BuildTalismans", b =>
                {
                    b.Property<int>("BuildTalismansId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BuildTalismansId"));
                    ...
                    b.HasKey("BuildTalismansId");

                    b.HasIndex("BuildId");

                    b.HasIndex("TalismanId");

                    b.ToTable("BuildTalismans");
                });
            ...
            modelBuilder.Entity("EldenRingCommunityApp.Models.JoinTables.BuildSpells", b =>
                {
                    b.HasOne("EldenRingCommunityApp.Models.Build", "Build")
                        .WithMany("BuildSpells")
                        .HasForeignKey("BuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EldenRingCommunityApp.Models.SubClasses.Spell", "Spell")
                        .WithMany("BuildSpells")
            ...
            modelBuilder.Entity("EldenRingCommunityApp.Models.JoinTables.BuildTalismans", b =>
                {
                    b.HasOne("EldenRingCommunityApp.Models.Build", "Build")
                        .WithMany("BuildTalismans")
                        .HasForeignKey("BuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EldenRingCommunityApp.Models.SubClasses.Talisman", "Talisman")
                        .WithMany("BuildTalismans")
            ...
            modelBuilder.Entity("EldenRingCommunityApp.Models.Build", b =>
                {
                    b.Navigation("BuildSpells");

                    b.Navigation("BuildTalismans");
